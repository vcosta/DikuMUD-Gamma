  ...
  struct char_data *victim, struct obj_data *tar_obj )
{
	switch (type) {
		case SPELL_TYPE_SPELL:
			...
			break;
    default : 
      logstr("Serious screw-up in burning hands!");
      break;
	}
}
  ...
  extern struct weather_data weather_info;
	...
	switch (type) {
      ...
      case SPELL_TYPE_STAFF:
			...
			break;
      default : 
         logstr("Serious screw-up in call lightning!");
         break;
	}
}
  ...
  struct char_data *victim, struct obj_data *tar_obj )
{
  switch (type) {
    case SPELL_TYPE_SPELL:
			...
			break;
      default : 
         logstr("Serious screw-up in chill touch!");
         break;
	}
}
  ...
  struct char_data *victim, struct obj_data *tar_obj )
{
  switch (type) {
    case SPELL_TYPE_SPELL:
			...
			break;
      default : 
         logstr("Serious screw-up in shocking grasp!");
         break;
	}
}
  ...
  struct char_data *victim, struct obj_data *tar_obj )
{
  switch (type) {
    ...
    case SPELL_TYPE_WAND:
         ...
         break;
    default : 
         logstr("Serious screw-up in colour spray!");
         break;
	}
}
  ...
  struct char_data *victim, struct obj_data *tar_obj )
{
  switch (type) {
    ...
    case SPELL_TYPE_STAFF:
	      ...
	      break;
    default : 
         logstr("Serious screw-up in earthquake!");
         break;
	}
}
  ...
  struct char_data *victim, struct obj_data *tar_obj )
{
  switch (type) {
    ...
    case SPELL_TYPE_STAFF:
         ...
         break;
    default : 
         logstr("Serious screw-up in energy drain!");
         break;
	}
}
  ...
  struct char_data *victim, struct obj_data *tar_obj )
{
  switch (type) {
    ...
    case SPELL_TYPE_WAND:
         ...
         break;
    default : 
         logstr("Serious screw-up in fireball!");
         break;
  ...
  struct char_data *victim, struct obj_data *tar_obj )
{
    ...
    case SPELL_TYPE_STAFF:
         ...
         break;
    default : 
         logstr("Serious screw-up in harm!");
         break;
  ...
  struct char_data *victim, struct obj_data *tar_obj )
{
  switch (type) {
    ...
    case SPELL_TYPE_WAND:
         ...
         break;
    default : 
         logstr("Serious screw-up in lightning bolt!");
         break;
  ...
  struct char_data *victim, struct obj_data *tar_obj )
{
  switch (type) {
    ...
    case SPELL_TYPE_WAND:
         ...
         break;
    default : 
         logstr("Serious screw-up in magic missile!");
         break;
